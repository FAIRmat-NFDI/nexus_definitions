...
Each tool of the paraprobe-toolbox uses one pair of application definitions. These
tool-specific application definitions inherit common parameter and settings from the
following tool-agnostic application definitions:

:ref:`NXapm_paraprobe_tool_config`, :ref:`NXapm_paraprobe_tool_results`:
    Configuration and results respectively.

These definitions use several tool-agnostic but atom probe specific base classes:
...
These are the proposed pairs for all tools in the paraprobe-toolbox:
